...
### 5.index.html単体
1.index.htmlの内容を全てコピーし、htmlに入れ込みます。初期設定ではhttps://yt-dlp-api-node.mangandenti.comになっているので、自分で作った他のプロキシURL入れれば動きます

### 取得するjsonデータの例 ※ドメインがブロックされている場合は、renderなどでリバースプロキシを作りましょう
