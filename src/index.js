...
<body>
  ...
  <script>
    ...
    try {
      ...
      const isTextOrScript = contentType.includes("text/") || contentType.includes("javascript") || contentType.includes("json");
      ...
      if (isTextOrScript) {
        ...
        text = text.replace(urlRegex, (match) => {
          try {
            ...
            if (extUrl.hostname.includes("mangandenti.com")) return workerUrl.origin;
            return match;
          } catch (e) {
            return match;
          }
